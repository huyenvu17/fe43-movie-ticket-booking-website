...
const statePhim = {
  ...
  movieTheater: [
    { maHeThongRap: "BHDStar", tenHeThongRap: "BHD Star Cineplex", biDanh: "bhd-star-cineplex", logo: "http://movie0706.cybersoft.edu.vn/hinhanh/bhd-star-cineplex.png" },
  ]
};
...
export default (state = statePhim, action) => {
  switch (action.type) {
    ...
    case MovieConst.GET_MOVIE_THEATER: {
      console.log('GET_MOVIE_THEATER', action.movieTheater)

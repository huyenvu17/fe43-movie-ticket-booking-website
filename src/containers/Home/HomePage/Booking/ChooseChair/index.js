...
export default function ChooseChair(props) {

  let { thongTinPhongVe, danhSachGheDangDat, setDanhSachGheDangDat } = props;
  const renderGhe = (daDat, ghe) => {
    if (daDat) {
      return <i className="fas fa-couch slot__item item--picked"></i>;
    } else {
      let cssGheDangDat = "";
      ...
      return (
        <i
          className={`fas fa-couch slot__item ${cssGheVip} ${cssGheDangDat}`}
          onClick={() => {
            datGhe(ghe);
          }}
        ></i>
          ...
          <div className="chooseSlot">
            ...
            <div className="slot__detail row">
              <div className="col-md-3 col-sm-6 col-xs-6">
                <i className="fas fa-couch item--picking" />
                <span className="slot__text">Ghế đang chọn</span>
              </div>
              <div className="col-md-3 col-sm-6 col-xs-6">
                <i className="fas fa-couch item--picked" />
                <span className="slot__text">Ghế đã chọn</span>
              </div>
              <div className="col-md-3 col-sm-6 col-xs-6">
                <i className="fas fa-couch item--regular" />
                <span className="slot__text">Ghế chưa chọn</span>
              </div>
              <div className="col-md-3 col-sm-6 col-xs-6">
                <i className="fas fa-couch item--vip" />
